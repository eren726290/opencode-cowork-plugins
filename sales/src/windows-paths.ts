...
export function getSalesStateDir(): string {
  return path.join(getUserHomeDir(), ".local", "share", "opencode-sales-agent")
}

export function getSalesStateFilePath(): string {
  return path.join(getSalesStateDir(), "state.json")
}
